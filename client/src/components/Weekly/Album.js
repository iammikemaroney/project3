      ...
      return(
        ...
        <div className="row container-fluid center">
          ...
          <div className="col s12 m12 l4">
            ...
            <iframe style={styles.movie} title= "movie" src="https://www.youtube.com/embed/oR_e9y-bka0?rel=0&amp;showinfo=0" width="100%" height= "200px" frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen></iframe>
