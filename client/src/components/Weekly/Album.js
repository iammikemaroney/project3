...
import AppleMusic from "../../img/icon-itunes.png";
import Spotify from "../../img/icon-spotify.png";
import Amazon from "../../img/icon-amazon.png";
        ...
        <div className="row container-fluid center">
          ...
          <div className="col s12 m12 l4">
            <div className="icon-block">
              ...
              <p className="light center"><a href="https://itunes.apple.com/us/album/hud-dreems/980151816" target="_blank"><img style={styles.thumb} src={AppleMusic} alt="appleMusic" /> Listen on Apple Music</a>
                <br /><a href="https://open.spotify.com/album/2hnFG95OCnV24yP4UDXlzl" target="_blank"><img style={styles.thumb} src={Spotify} alt="Spofity" /> Listen on Spotify</a></p>
            </div>
          </div>
          <div className="col s12 m12 l4">
            <div className="icon-block">
            ...
            <iframe style={styles.movie} title= "movie" src="https://www.youtube.com/embed/oR_e9y-bka0?rel=0&amp;showinfo=0" width="100%" frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen></iframe>
            ...
            <p className="light"><a href="https://itunes.apple.com/us/movie/2001-a-space-odyssey/id285993250" target="_blank"><img style={styles.thumb} src={Movie} alt="iTunes" /> Rent on iTunes</a>
              <br /><a href="https://www.amazon.com/2001-Space-Odyssey-Keir-Dullea/dp/B000HEBCZQ/ref=sr_1_2?s=instant-video&ie=UTF8&qid=1526668766&sr=1-2&keywords=2001+a+space+odyssey" target="_blank"><img style={styles.thumb} src={Amazon} alt="Amazon" /> Rent on Amazon</a></p>
          </div>
          <div className="col s12 m12 l4">
          <div className="icon-block">
